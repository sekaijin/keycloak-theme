...
<@layout.registrationLayout displayInfo=social.displayInfo displayWide=false; section>
    ...
    <div id="kc-form" <#if realm.password && social.providers??>class="${properties.kcContentWrapperClass!}"</#if>>
                    ...
                    <#list social.providers as p>					
                        <li class="${properties.kcFormSocialAccountListLinkClass!}">
							 <a href="${p.loginUrl}" id="zocial-${p.alias}" class="zocial ${p.providerId}">								
								<i class="${properties.kcCommonLogoIdP!} ${properties.aphpLogoKey!}" aria-hidden="true"></i>
								<span class="kc-social-icon-text">${p.displayName!}</span>								
							</a>
						</li>						
                    </#list>
					<li class="${properties.kcFormSocialAccountListLinkClass!}">
						<a class="${properties.aphpFormToggle!}" href="#kc-form" onclick="return toggle(this)">
							${msg("showLoginForm")}
						</a>
					</li>
                </ul>
      ...
      <div id="kc-form-wrapper"<#if realm.password && social.providers??>style="display: none"</#if>>
        <#if realm.password>
